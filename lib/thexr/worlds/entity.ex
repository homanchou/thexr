defmodule Thexr.Worlds.Entity do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  schema "entities" do
    field(:snapshot_id, :string, primary_key: true)
  ...
  def changeset(state, attrs) do
    state
    |> cast(attrs, [:snapshot_id, :id, :components])
    |> validate_required([:snapshot_id, :id, :components])
