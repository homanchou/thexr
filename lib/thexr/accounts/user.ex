defmodule Thexr.Accounts.User do
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Thexr.Repo)
  ...
  defp maybe_validate_unique_nickname(changeset, opts) do
    if Keyword.get(opts, :validate_nickname, true) do
      changeset
      |> unsafe_validate_unique(:nickname, Thexr.Repo)
  ...
  """
  def valid_password?(%Thexr.Accounts.User{hashed_password: hashed_password}, password)
